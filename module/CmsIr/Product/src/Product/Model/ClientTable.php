...
class ClientTable extends ModelTable
{
    ...
    public function getDataToDisplay($filteredRows, $columns)
    {
        ...
        foreach($filteredRows as $row) {
            ...
            $tmp[] = '<a href="client/edit/'.$row->getId().'" class="btn btn-primary" data-toggle="tooltip" title="Edycja"><i class="fa fa-pencil"></i></a> ' .
                     '<a href="client/delete/'.$row->getId().'" id="'.$row->getId().'" class="btn btn-danger" data-toggle="tooltip" title="Usuwanie"><i class="fa fa-trash-o"></i></a>';
